...
# modified kNN with dual time transition
class kNNGraph(DataGraph):
    ...
    smooth_window: 'int'(default:None)
        Number of time points prior to or after the current time points to build trasition to
        if None, single transition , no time transition
    Attributes
    ----------
